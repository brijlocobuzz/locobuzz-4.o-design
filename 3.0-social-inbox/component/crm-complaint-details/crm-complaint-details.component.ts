...
@Component({
    selector: 'app-crm-complaint-details',
    templateUrl: './crm-complaint-details.component.html',
    styleUrls: ['./crm-complaint-details.component.scss'],
    standalone: false
})
export class CrmComplaintDetailsComponent implements OnInit {
  isLoading: boolean;
  constructor(
  ...
  ngOnInit(): void {
    ...
    const crmdetailsobject = {
      ...
      RequestTypes: BTCCrmRequestType.Complaint,
    };
    this.isLoading = true;
